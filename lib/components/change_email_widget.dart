            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(12.0, 0.0, 12.0, 0.0),
                  child: Text(
                    'Change How You Access Your Account',
                  ...
                  child: Row(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'CHANGE_EMAIL_COMP_CANCEL_BTN_ON_TAP');
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent('CHANGE_EMAIL_COMP_SAVE_BTN_ON_TAP');
                          if (_model.emailTextController.text != '') {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  ' Updated Your Email Successfully!',
