            ...
            Row(
              ...
              children: [
                ...
                InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('ADD_EXAM_COMP_Icon_389ate1w_ON_TAP');
                ...
                children: [
                      ...
                      children: [
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            ...
                            hintText: 'Select the exam category',
                            icon: Icon(
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText:
                                  'Exam syllabus, instructions, or a brief overview of the exam.',
                              hintStyle: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: FlutterFlowTheme.of(context)
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      obscureText: false,
                      decoration: InputDecoration(
                        hintText: 'classroom, exam hall, place name, etc.',
                        hintStyle: FlutterFlowTheme.of(context)
                            .labelLarge
                            .override(
                              fontFamily:
                      ...
                      Flexible(
                        child: Align(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              logFirebaseEvent('ADD_EXAM_COMP_deadline_ON_TAP');
                              logFirebaseEvent('deadline_date_time_picker');
