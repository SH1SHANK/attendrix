...
export 'schedule_notification_model.dart';
...
class _ScheduleNotificationWidgetState
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScheduleNotificationModel());
