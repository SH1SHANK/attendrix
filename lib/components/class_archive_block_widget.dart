...
class ClassArchiveBlockWidget extends StatefulWidget {
  ...
  final PersonalRecordsRecord? classRecord;
...
class _ClassArchiveBlockWidgetState extends State<ClassArchiveBlockWidget>
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<TimetableRecordsRow>>(
      future: FFAppState().timetableQueryIndividual(
        uniqueQueryKey: valueOrDefault<String>(
          widget.classRecord?.recordId,
          'class_key',
        ),
        requestFn: () => TimetableRecordsTable().querySingleRow(
      ...
      builder: (context, snapshot) {
        ...
        List<TimetableRecordsRow> containerTimetableRecordsRowList =
            snapshot.data!;

        final containerTimetableRecordsRow =
            containerTimetableRecordsRowList.isNotEmpty
                ? containerTimetableRecordsRowList.first
                : null;
          ...
          child: Container(
            decoration: BoxDecoration(
              color: valueOrDefault<Color>(
                widget.classRecord?.colorSchema,
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                valueOrDefault<String>(
                                  containerTimetableRecordsRow?.courseName,
                                  'Mathematics III',
                                ),
