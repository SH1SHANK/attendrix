      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                ...
                InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent(
                        'ADD_ASSIGNMENT_COMP_Icon_hl9g17pl_ON_TAP');
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Name Of The Assignment',
                        hintStyle:
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText:
                                  'assignment details, instructions, submission procedure',
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      obscureText: false,
                      decoration: InputDecoration(
                        hintText: 'https://google.drive.com/',
                        hintStyle:
                            FlutterFlowTheme.of(context).labelMedium.override(
                                  fontFamily: FlutterFlowTheme.of(context)
                                      .labelMediumFamily,
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(4.0, 10.0, 4.0, 4.0),
                    child: Text(
                      'Assignment Deadline',
                      style: FlutterFlowTheme.of(context).labelSmall.override(
                            fontFamily:
                        ...
                        child: Align(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'ADD_ASSIGNMENT_COMP_deadline_ON_TAP');
            ...
            FFButtonWidget(
              onPressed: () async {
                logFirebaseEvent('ADD_ASSIGNMENT_POST_ASSIGNMENT_BTN_ON_TA');
                logFirebaseEvent('Button_backend_call');
                _model.assignmentFeedback = await TaskRecordsTable().insert({
                  'created_at': supaSerialize<DateTime>(getCurrentTimestamp),
                  'courseID': _model.dropDownValue,
                  'taskType': TaskType.assignment.name,
                  'taskName': _model.nameTextController.text,
                  'taskDescription': _model.descriptionTextController.text,
                  'taskStartTime': supaSerialize<DateTime>(_model.datePicked),
                  'taskEndTime': supaSerialize<DateTime>(_model.datePicked),
                  'taskAssets': _model.linkTextController.text,
                  'taskDueDate': supaSerialize<DateTime>(_model.datePicked),
                });
