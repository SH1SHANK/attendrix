...
class SupportSubmitTicketWidget extends StatefulWidget {
  ...
  static String routeName = 'support_SubmitTicket';
  static String routePath = 'supportSubmitTicket';
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                          ...
                                          Expanded(
                                            child: Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'SUPPORT_SUBMIT_TICKET_Container_vqo7wywc');
                                                  logFirebaseEvent(
                                                      'Container_send_email');
                                                  await launchUrl(Uri(
                                                      scheme: 'mailto',
                                                      path:
                                                          'support@attendrix.site',
                                                      query: {
                                                        'subject':
                                      ...
                                      if (_model.uploadedFileUrl_uploadDataXhs !=
                                              '')
                                        ClipRRect(
                                          borderRadius:
                                      ...
                                      Align(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'SUPPORT_SUBMIT_TICKET_Container_nud8pcjy');
                                            logFirebaseEvent(
                                            ...
                                            if (selectedMedia != null &&
                                              ...
                                              try {
                                                ...
                                                _model.isDataUploading_uploadDataXhs =
                                                    false;
                                              }
                                              if (selectedUploadedFiles
                                                  ...
                                                  downloadUrls.length ==
                                                      selectedMedia.length) {
                                                safeSetState(() {
                                                  _model.uploadedLocalFile_uploadDataXhs =
                                                      selectedUploadedFiles
                                                          .first;
                                                  _model.uploadedFileUrl_uploadDataXhs =
                                                      downloadUrls.first;
                                                });
                                              } else {
                                                safeSetState(() {});
                            ...
                            onPressed: () async {
                              ...
                              await SupportTicketsRecord.collection
                                  ...
                                  .set(createSupportTicketsRecordData(
                                    ...
                                    status: 'Submitted',
                                    image: _model.uploadedFileUrl_uploadDataXhs !=
                                                ''
                                        ? _model.uploadedFileUrl_uploadDataXhs
                                        : null,
                                    ticketID:
