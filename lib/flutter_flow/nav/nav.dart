      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: ManageClassesWidget.routeName,
              path: ManageClassesWidget.routePath,
              requireAuth: true,
              builder: (context, params) => ManageClassesWidget(),
            ),
            FFRoute(
                ...
                builder: (context, params) => params.isEmpty
                    ...
                    : NavBarPage(
                        initialPage: 'attendance',
                        page: AttendanceWidget(),
                      )),
            FFRoute(
            ...
            FFRoute(
              name: AnnounementWidget.routeName,
              path: AnnounementWidget.routePath,
              builder: (context, params) => AnnounementWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: StudyMaterialsWidget.routeName,
              path: StudyMaterialsWidget.routePath,
              requireAuth: true,
              builder: (context, params) => StudyMaterialsWidget(),
            ),
            FFRoute(
              name: FileManagerWidget.routeName,
              path: FileManagerWidget.routePath,
              requireAuth: true,
              builder: (context, params) => FileManagerWidget(
            ...
            FFRoute(
              name: CustomClassesWidget.routeName,
              path: CustomClassesWidget.routePath,
              requireAuth: true,
              builder: (context, params) => CustomClassesWidget(),
            ),
            FFRoute(
              name: TaskArchivesWidget.routeName,
              path: TaskArchivesWidget.routePath,
              builder: (context, params) => TaskArchivesWidget(),
            ),
            FFRoute(
