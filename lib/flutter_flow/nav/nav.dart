...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/all_classes_overview',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'CompletedClasses')
              : const NavBarPage(
                  initialPage: 'CompletedClasses',
                  page: CompletedClassesWidget(),
                ),
        ),
        FFRoute(
          name: 'bugReportForm',
          path: '/bugReportForm',
          builder: (context, params) => BugReportFormWidget(
            issueType: params.getParam(
              'issueType',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: 'JoinTheDevTeam',
          path: '/joinTheDevTeam',
          builder: (context, params) => const JoinTheDevTeamWidget(),
        ),
        FFRoute(
          name: 'Assignments',
          path: '/assignments',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Assignments')
        ...
        FFRoute(
          ...
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'exams') : const ExamsWidget(),
        ),
        FFRoute(
