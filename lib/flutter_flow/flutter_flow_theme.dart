...
abstract class FlutterFlowTheme {
  ...
  late Color velvetSky;
  late Color mintGreen;
  late Color alternateSuccess;
  late Color presentGreen;
  late Color absentRed;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color success = const Color(0xFF03C03C);
  late Color warning = const Color(0xFFFFD700);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);

  late Color velvetSky = const Color(0xFF7B6FF8);
  late Color mintGreen = const Color(0xFF6EE7B7);
  late Color alternateSuccess = const Color(0xFF05FA2F);
  late Color presentGreen = const Color(0xFF37D437);
  late Color absentRed = const Color(0xFFE44D2E);
  late Color background2 = const Color(0xFFF2F1FF);
  late Color pure = const Color(0xFFFFFFFF);
}
