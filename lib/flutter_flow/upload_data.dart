          ...
          children: [
            if (!kIsWeb) ...[
              Padding(
                ...
                child: ListTile(
                  title: Text(
                    'Where’s your file coming from? Pick a source.',
                    textAlign: TextAlign.center,
                    style: GoogleFonts.getFont(
                      pickerFontFamily,
            ...
            if (allowPhoto && allowVideo) ...[
              ...
              createUploadMediaListTile(
                'Grab something from your gallery',
                MediaSource.photoGallery,
              )
            else
              createUploadMediaListTile(
            ...
            if (!kIsWeb) ...[
              const Divider(),
              createUploadMediaListTile(
                  'Snap it live with your camera', MediaSource.camera),
              const Divider(),
            ],
...
bool validateFileFormat(String filePath, BuildContext context) {
  ...
  ScaffoldMessenger.of(context)
    ...
    ..showSnackBar(SnackBar(
      content: Text('This file ain’t it. Try a supported format.'),
    ));
  return false;
}
