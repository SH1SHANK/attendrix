...
import '/components/change_display_name_widget.dart';
                              ...
                              child: Column(
                                ...
                                children: [
                                              ...
                                              image: DecorationImage(
                                                ...
                                                image:
                                                  ...
                                                  valueOrDefault<String>(
                                                    currentUserPhoto,
                                                    'https://images.unsplash.com/photo-1610483178766-8092d96033f3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxMnx8bGVnb3xlbnwwfHx8fDE3NDY3NjI2OTB8MA&ixlib=rb-4.1.0&q=80&w=1080',
                                                  ),
                                                ),
                                              ),
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'SETTINGS_PAGE_Container_4bsaxxe8_ON_TAP');
                              ...
                              children: [
                                ...
                                Builder(
                                  builder: (context) => InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'SETTINGS_PAGE_Row_wafiq1ti_ON_TAP');
                                      logFirebaseEvent('Row_alert_dialog');
                                      await showDialog(
                                        context: context,
                                        builder: (dialogContext) {
                                  ...
                                  children: [
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        valueOrDefault<String>(
                                          valueOrDefault(
                                              currentUserDocument?.semesterID,
                                              ''),
                                          '3',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'SETTINGS_PAGE_Container_jb8u3bx0_ON_TAP');
                                        logFirebaseEvent(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'SETTINGS_PAGE_CUSTOMIZE_BTN_ON_TAP');
                                        logFirebaseEvent('Button_navigate_to');

                                        context.pushNamed(
                                            CustomizeNotificationsWidget
                                                .routeName);
                                      },
                                      text: 'Customize',
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'SETTINGS_PAGE_Row_35zfgbmw_ON_TAP');
                                ...
                                Row(
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Text(
                                        'App Version: v0.0.5 Closed Beta 01',
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily:
