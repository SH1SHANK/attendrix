...
class _ClassesWidgetState extends State<ClassesWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.missedClassesQuery = await actions.getMissedClasses(
        currentUserUid,
      ...
      _model.missedClasses =
          _model.missedClassesQuery!.toList().cast<ClassRowStruct>();
                                                              ...
                                                              return Padding(
                                                                ...
                                                                child:
                                                                  ...
                                                                  child:
                                                                      ClassBlockGeneralWidget(
                                                                    key: Key(
                                                                      'Key6pt_${customClassesListItem.classID}',
                                                                    ),
                                                                    classID:
                                                                        customClassesListItem
                                                                            .classID,
                                                                    ...
                                                                    classStartTime:
                                                                        functions
                                                                            .convertToDateTime(customClassesListItem.classStartTime),
                                                                    classEndTime:
                                                                        functions
                                                                            .convertToDateTime(customClassesListItem.classEndTime),
                                                                    weekday:
                                                                        pastDateItem,
                                                                  ),
                                                                ),
