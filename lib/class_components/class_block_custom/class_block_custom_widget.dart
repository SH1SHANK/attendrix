  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.isCancelledQuery = await actions.checkClassCancellation(
        widget.courseID!,
        functions.parseDateTime(widget.weekday!, widget.classStartTime!),
      ...
      builder: (context) => InkWell(
        ...
        onTap: () async {
              ...
              builder: (dialogContext) {
                return Dialog(
                  ...
                  child: ClassCheckInDialogWidget(
                    ...
                    classStartTime: functions.parseDateTime(
                        widget.weekday!, widget.classStartTime!),
              ...
              builder: (dialogContext) {
                return Dialog(
                  ...
                  child: ClassCheckOutDialogWidget(
                    ...
                    className: widget.courseName,
                    isCustomClass: true,
                    classEndTime: functions.parseDateTime(
                        widget.weekday!, widget.classEndTime!),
          ...
          if (!_model.isCancelled) {
            ...
            _model.isCancelledRefreshed = await actions.checkClassCancellation(
              widget.courseID!,
